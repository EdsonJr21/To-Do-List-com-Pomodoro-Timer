...
const btnRemoverConcluido = document.querySelector('#btn-remover-concluidas')
...
function criarElementoTarefa(tarefa) {
    ...
    botao.onclick = () => {
        const novaDescricao = prompt("Qual é o novo nome do botão ?")
...
btnRemoverConcluido.onclick = () => removerTarefas(true)
